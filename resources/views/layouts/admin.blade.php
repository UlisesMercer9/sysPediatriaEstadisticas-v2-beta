      ...
      <nav class="banner">
       <div class="nav-wrapper #880e4f pink darken-4 "> 
        ...
        <div class="col l12">
         ...
         <a href="#" data-activates="slide-out" class="button-collapse"><i class="material-icons">menu</i></a>
           ...
           <li class="mobil-2" >
              <a id="opcion1" href="#">
                <img src="/perfil/thumb_{{Auth::user()->get()->path}}" class="circle user-image-2 z-depth-2 left" alt="User imagen">
    
                <span class="right">{!!Auth::user()->get()->name!!}</span>
               </a>
           </li>
           <li class="mobil-2">
       ...
       <!--    MENU LATERAL   -->
                ...
                <div class="row " id="menu">
                   <div id="slide-out" class="side-nav fixed row menu blue-grey darken-4">

                       <div id="blank-space"></div>
                       <div class="truncate"></div>
                       <div class="space">
                          <div class="col s3">
                            <img src="/perfil/thumb_{{Auth::user()->get()->path}}" class="circle user-image z-depth-2" alt="User imagen">
                          </div>
                          <div class="col s9 ">
                            <p class="left-align white-text name-text">{!!Auth::user()->get()->name!!}</p>   
                         </div>       
                       </div>
                       ...
                       <div class="card-panel #000000 black z-depth-2">
                          ...
                          <ul>
                             <li >
                               <a href="{!!URL::to('/admin')!!}" class="opcion white-text waves-effect waves-light">
                                  <i class="fa fa-user"></i>
                                    &nbsp;&nbsp;Administradores
                               </a>
                             </li>
                             <li >
                               <a href="{!!URL::to('/especialista')!!}" class="opcion white-text waves-effect waves-light">
